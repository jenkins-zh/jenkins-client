...
var _ = Describe("PluginManager test", func() {
	...
	Context("GetAvailablePlugins", func() {
		It("no plugin in the list", func() {
			core.PrepareForEmptyAvaiablePluginList(roundTripper, pluginMgr.URL)
		...
		It("one plugin in the list", func() {
			core.PrepareForOneAvaiablePlugin(roundTripper, pluginMgr.URL)
		...
		It("many plugins in the list", func() {
			core.PrepareForManyAvaiablePlugin(roundTripper, pluginMgr.URL)
	...
	Context("GetPlugins", func() {
		It("no plugin in the list", func() {
			core.PrepareForEmptyInstalledPluginList(roundTripper, pluginMgr.URL, 1)
		...
		It("response with 500", func() {
			core.PrepareFor500InstalledPluginList(roundTripper, pluginMgr.URL, 1)
		...
		It("test with parameter", func() {
			core.PrepareForManyInstalledPlugins(roundTripper, pluginMgr.URL, 2)
	...
	Context("InstallPlugin", func() {
		...
		It("normal case, should success", func() {
			core.PrepareForInstallPlugin(roundTripper, pluginMgr.URL, pluginName, "", "")
		...
		It("upload a plugin with a specific version, should success", func() {
			...
			core.PrepareForUploadPlugin(roundTripper, pluginMgr.URL)
		...
		It("with 400", func() {
			core.PrepareForInstallPluginWithCode(roundTripper, 400, pluginMgr.URL, pluginName, "", "")
		...
		It("with 400, error message", func() {
			response := core.PrepareForInstallPluginWithCode(roundTripper, 400, pluginMgr.URL, pluginName, "", "")
	...
	Context("UninstallPlugin", func() {
		...
		It("normal case, should success", func() {
			core.PrepareForUninstallPlugin(roundTripper, pluginMgr.URL, pluginName)
		...
		It("response with 500", func() {
			core.PrepareForUninstallPluginWith500(roundTripper, pluginMgr.URL, pluginName)
	...
	Context("UpdateCenter", func() {
		It("normal case, should success", func() {
			core.PrepareForRequestUpdateCenter(roundTripper, pluginMgr.URL)
	...
	Context("NullUpdateCenter", func() {
		It("normal case, should success", func() {
			core.PrepareForNoAvailablePlugins(roundTripper, pluginMgr.URL)
	...
	Context("ManyInstalledPlugins", func() {
		It("normal case, should success", func() {
			core.PrepareForManyInstalledPlugins(roundTripper, pluginMgr.URL, 1)
	...
	Context("500UpdateCenter", func() {
		It("normal case, should success", func() {
			core.PrepareForRequest500UpdateCenter(roundTripper, pluginMgr.URL)
